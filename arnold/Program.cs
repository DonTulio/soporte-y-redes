...
namespace arnold
{
    class Program
    {
        ...
        private static string rutaSalida = Path.Join(rutaEscritorio, "documentación");
        ...
        private static void ObtenerBIOS() {
            ...
            string rutaBios = Path.Join(rutaSalida, "BIOS.txt");
        ...
        private static void ObtenerCPU() {
            ...
            string rutaCPU = Path.Join(rutaSalida, "CPU.txt");
            Process procesoBios = new Process
            {
                StartInfo = new ProcessStartInfo
                {
        ...
        private static void ObtenerRedes() {
            ...
            string rutaRED = Path.Join(rutaSalida, "REDES.txt");
            Process procesoBios = new Process
            {
                StartInfo = new ProcessStartInfo
                {
        ...
        private static void ObtenerSystem() {
            ...
            string rutaSystem = Path.Join(rutaSalida, "SYSTEM.txt");
            Process procesoBios = new Process
            {
                StartInfo = new ProcessStartInfo
                {
        ...
        private static void ObtenerCSPRODUCT() {
            ...
            string rutaProducto = Path.Join(rutaSalida, "PRODUCTO.txt");
            Process procesoBios = new Process
            {
                StartInfo = new ProcessStartInfo
                {
        ...
        private static void ObtenerRAM()
        {
            ...
            string rutaRam = Path.Join(rutaSalida, "RAM.txt");
            Process procesoBios = new Process
            {
                StartInfo = new ProcessStartInfo
                {
